...
namespace Lab1
{
    ...
    // а потом я посмотрела гайд в мудл (когда уже все написала) и поняла что в следующий раз полностью просмотрю инструкции, ибо я могла не заморачиваться и писать код сразу в мейне(
